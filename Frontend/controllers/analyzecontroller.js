...
function buildCommonViewModel(obj, text, explain) {
  ...
  return {
    ...
    token_text: hasDetailed ? detailed.token_text : "",
...
function runPythonAndRender(req, res, viewName) {
...
exports.analyzeWithPython = (req, res) => {
  runPythonAndRender(req, res, "home");
};

exports.analyzeWithPythonDetailed = (req, res) => {
  runPythonAndRender(req, res, "home_explain");
};